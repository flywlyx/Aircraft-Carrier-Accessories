...
using UnityEngine;
    ...
    public class ReloadableRail : PartModule
    {
        ...
        [KSPAction("Reassign", KSPActionGroup.None)]
                    ...
                    if (AP.partPrefab.name == MissileName)
                    {
                        foreach (PartModule m in AP.partPrefab.Modules)
                        {
                            if (m.moduleName == "MissileLauncher")
                            {
                                ...
                                CreatePart(partNode, MissileTransform.transform.position - MissileTransform.TransformDirection(AP.partPrefab.srfAttachNode.originalPosition), this.part.transform.rotation, this.part, this.part, "srfAttach");
                            }
                        }
                    }
                }
